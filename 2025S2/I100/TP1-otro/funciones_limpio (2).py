...
def mover_y_reproducir_zorros(snapshot, nueva, edades_zorros_muertos, edades_conejos_muertos, e_min, prz, ez, gz, N):
  """
...
def simular_turno(N, grilla_inicial, turnos_totales, e_min, prz, prc, ez, ec, gc, gz, pp, edades_zorros_muertos, edades_conejos_muertos, animar=True):
  ...
  for turno in range(turnos_totales):
    ...
    mover_y_reproducir_zorros(snapshot, grilla, edades_zorros_muertos, edades_conejos_muertos, e_min, prz, ez, gz, N)
